...
export default function Products() {
  ...
  // 18 WENAS PRODUCTS (Roofing Catalog) 
  const productsList = [
    // Page 1 (0 to 5)
    { id: 1, title: "Clay Roofing Tiles", desc: "Classic aesthetic with excellent thermal insulation.", img: "https://images.unsplash.com/photo-1614418583513-8e96d9160333?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D=80&w=600" },
    ...
    { id: 12, title: "Industrial Floor Boards", desc: "Heavy-duty load bearing boards for mezzanine floors.", img: "https://images.unsplash.com/photo-1632255758400-d51330d2279a?q=80&w=678&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D=80&w=600" },
    ...
    { id: 14, title: "Welded Wire Mesh", desc: "High-tensile steel mesh for concrete reinforcement.", img: "https://images.unsplash.com/photo-1651890331040-b3e99782661f?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D=80&w=600" },
    { id: 15, title: "Reinforcing Steel Rebar", desc: "TMT ribbed bars for core structural stability.", img: "https://images.unsplash.com/photo-1763771420551-18bc44399f0c?q=80&w=1477&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D=80&w=600" },
    ...
    { id: 17, title: "Square Downpipes", desc: "Architecturally sleek downpipes for high-capacity drainage.", img: "https://images.unsplash.com/photo-1562545714-62c15e7fdf9e?q=80&w=715&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D=80&w=600" },
    { id: 18, title: "High-Tensile Fasteners", desc: "Professional-grade self-drilling screws and sealants.", img: "https://images.unsplash.com/photo-1605701249987-f0bb9b505d06?q=80&w=1472&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D=80&w=600" },
  ];
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {currentProducts.map((product) => (
            <motion.div 
              key={product.id} 
              // ✨ Kalin thibba gray color ekai size ekai ayeth damma ✨
            ...
            >
              ...
              <div className="relative z-10 w-[55%] md:w-[50%] flex flex-col justify-center h-full">
                ...
                {/* Thick Red Line */}
                <div className="h-[3px] w-12 md:w-14 bg-[#cc3333] group-hover:w-16 transition-all duration-300"></div>
              </div>

              {/* Product Image (Right Side - Properly contained) */}
              <div className="absolute right-4 md:right-5 top-4 md:top-5 bottom-12 md:bottom-14 w-[35%] md:w-[38%] rounded-[16px] overflow-hidden shadow-sm">
                <img 
                  src={product.img} 
                  alt={product.title} 
              ...
              {/* ✨ Kalu paata dot eka (Black Pill) kalin wage ma thiyenawa ✨ */}
              <div className="absolute bottom-4 md:bottom-5 right-4 md:right-5 w-6 md:w-8 h-2.5 md:h-3 bg-[#1a1a1a] rounded-full transition-transform group-hover:scale-110"></div>
            </motion.div>
          ))}
        </motion.div>
      </AnimatePresence>
